...
void turn90_left(){
        ...
        while(1){
          ...
          if ((newposl/(2248.86)<18){
            digitalWrite(RIGHT_FORWARD,HIGH);
            digitalWrite(RIGHT_BACKWARD,LOW);
            digitalWrite(RIGHT_MOTOR_ENABLE,HIGH);
            analogWrite(RIGHT_MOTOR_PWM,w_r);
          
            digitalWrite(LEFT_FORWARD,HIGH);
            digitalWrite(LEFT_BACKWARD,LOW);
            digitalWrite(LEFT_MOTOR_ENABLE,HIGH);
            analogWrite(LEFT_MOTOR_PWM,w_l);
            }
          else{
            break;
            } 
...
void loop(){
          ...
          if(is_even){
                if(Left4==1 && Left3==1 && Left1==0){
                  forward();}
                else if(Left4==1 && Left3==1 && Left2==1 && Left1==1){
                  hit_break();}
                else if(Left4==0 && Left3==0 && Left2==0 && Left1==0){
                  square();}
          }
          else{
            if((Left4==0 && Left3==0 && Left2==0 && Left1==0 && Right1==0) &&  (Right2==1 &&  Right3==1 && Right4==1)){
              turn90_left();}
            if((Left4==1 && Left3==1 && Left2==1 ) &&  (Left1==0 && Right1==0 && Right2==0 && Right3==0 && Right4==0)){
              turn90_right();}
            if((Left4==0 ||  Left3==0  ) &&  (Right1==1 || Right2==1 || Right3==1 || Right4==1)){
              turn_left();}
            else if((Left4==1 ||  Left3==1  || Left2==1 || Left1==1) &&  ( Right3==0 || Right4==0)){
              turn_right();}
          }
